    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(options =>
                options.UseNpgsql(Configuration.GetConnectionString("DanyaConnection")));
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("Client", policy =>
                {
                    ...
                    policy.RequireClaim(ClaimsIdentity.DefaultRoleClaimType, "client");
                    policy.RequireClaim(ClaimsIdentity.DefaultRoleClaimType, "admin");
                ...
                options.AddPolicy("Driver", policy =>
                {
                    policy.RequireAssertion(x =>
                        x.User.HasClaim(ClaimsIdentity.DefaultRoleClaimType, "driver") ||
